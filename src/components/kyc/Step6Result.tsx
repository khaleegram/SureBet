...
const statusConfig = {
  success: {
    ...
    description: 'Welcome to House of the Royal Goose. You will be redirected to your dashboard shortly.',
  },
  failure: {
...
export function Step6Result({ status, messages }: Step6ResultProps) {
